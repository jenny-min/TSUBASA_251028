...
CREATE TABLE `order_items` (
  ...
  CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`ProductId`) REFERENCES `products1` (`ProductId`)
...
CREATE TABLE `orders` (
  ...
  `OrderStatus` enum('NEW','PAID','CANCELLED') NOT NULL DEFAULT 'NEW',
  PRIMARY KEY (`OrderId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-27 16:38:41
